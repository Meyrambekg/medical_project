...
class UserInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'iin', 'name', 'surname', 'phone', 'avatar', 'birth_date', 'user_type', 'is_superuser', 'last_login')


class UserUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'iin', 'name', 'surname', 'phone', 'avatar', 'birth_date', 'user_type')
        read_only_fields = ('id', 'iin')
